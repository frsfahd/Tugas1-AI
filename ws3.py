...
# Update by Yaya Wihardi (yayawihardi@upi.edu) on 03/15/2020
...
class Application:
    def __init__(self, human=True, scale=20, fps=30,alt_color=False):
        ...
        self.scale = scale
        self.fps = fps
        self.windowTitle = "Kecerdasan Buatan: "
        self.__human = human
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Kecerdasan Buatan - Search')
